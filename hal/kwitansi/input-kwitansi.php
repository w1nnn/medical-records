									...
									<form action="proses-simpan.php" name="perhitungan" method="post">
										...
										<table width="100%" border="0" cellspacing="4" cellpadding="0" class="tabel_reg">
											...
											<tr>
												...
												<td><input name="no_kuyut" type="text" size="40" value="<?php echo  $nextID; ?>" disabled> <em>
											...
											<tr>
												<td>Tgl. Kwitansi</td>
												<td><input name="tanggal" type="text" size="40" value="<?php echo $tglsekarang; ?>"> <em>
														<font color="red">Otomatis</font>
													</em></td>
											</tr>
											...
											<tr>
												<td>Nama Pasien</td>
												<td><input name="nama_pasien" id="nama_pasien" type="text" size="40" value="" disabled> <em>
														<font color="red">Otomatis</font>
													</em></td>
											</tr>
											...
											<script type="text/javascript">
												...
												function calc() {
													administrasi = document.perhitungan.b_administrasi.value;
											...
											<tr>
												<td>Total</td>
												<td>Rp. <input name="tohong" type="text" size="40" value="" disabled> <em>
														<font color="red">Otomatis</font>
													</em></td>
											...
											<tr>
												<td>Kembali</td>
												<td>Rp. <input type=text name="kunyuk" value="" onFocus="startCalc();" onBlur="stopCalc();" size="40" disabled> <em>
														<font color="red">Otomatis</font>
													</em></td>
