								...
								<div style="padding:10px 0 10px 0 ">
									...
									<form action="proses-simpan.php" name="" method="post">
										...
										<table width="100%" border="0" cellspacing="4" cellpadding="0" class="tabel_reg">
											...
											/*pertama kita panggil kolom yang akan kita gunakan untuk ID kita dengan menyaring nilai maksimum */
											...
											<tr>
												...
												<td><input name="no_roso" type="text" size="40" value="<?php echo  $nextID; ?>" disabled> <em>
