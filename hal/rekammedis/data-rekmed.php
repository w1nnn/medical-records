			...
			<div id="page">
				...
				<div id="body_content">
					<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-left:-11px">
						...
						$result = mysqli_query($conn, "SELECT * FROM tb_rekmed");
						?>
							...
							<table width="100%" border="1" cellpadding="5" cellspacing="1">
								...
								?>
									<tr>
										...
										<td>
											<center><a href="hasil.php?no_rekmed=<?php echo $data['no_rekmed']; ?>" target="blank"><img src="http://localhost/puskesmas/images/print.png" /></a> | <a href="proses-hapus.php?no_rekmed=<?php echo $data['no_rekmed']; ?>"><img src="http://localhost/puskesmas/images/hapus.png" /></a></center>
										</td>
									</tr>
								<?php
									$no++;
