...
<hr>
				...
				$result = mysql_query("select * from tb_kwitansi");
				?>
            ...
            <tr>
                ...
                <td><center><a href="kwitansi.php?no_kwitansi=<?php echo $data['no_kwitansi']; ?>" target="blank"><img src="http://localhost/puskesmas/images/print.png" /></a></center></td>
			</tr>
			<?php
                                $no++;
                }
