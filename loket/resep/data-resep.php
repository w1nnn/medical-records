...
<hr>
				...
				$result = mysql_query("select * from tb_resep");
				?>
            ...
            <tr>
                ...
                <td><center><a href="resep.php?no_resep=<?php echo trim($data['no_resep']); ?>" target="blank"><img src="http://localhost/puskesmas/images/print.png" /></a> | <a href="tampil-resep.php?no_resep=<?php echo trim($data['no_resep']); ?>"><img src="http://localhost/puskesmas/images/tut.png" /></a></center></td>
			</tr>
			<?php
                                $no++;
                }
