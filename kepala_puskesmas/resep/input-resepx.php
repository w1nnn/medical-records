...
// selesai,,, untuk memanggil ID otomatis ini  bisa memasangkan cara
 ...
 <input name="no_resep" type="text" value="<?php echo $nextIDx; ?>" style="display: none"> 
		...
		<th>Kode Obat</th>
		<td>
		<select name="kode_obat" id="kode_obat" onchange="kdObat(this.value)" >
    ...
    while ($row = mysql_fetch_array($result)) {   
        ...
        $jsArray .= "dt_obat['" . $row['kode_obat'] . "'] = {nama_obat:'" . addslashes($row['nama_obat']) . "',jenis:'".addslashes($row['jenis'])."',jumlah:'".addslashes($row['jumlah'])."'};\n";   
    }     
    ?>   
			...
			<tr>
		<td>Nama Obat</td>
		<td><input name="nama_obat" id="nama_obat"type="text" size="35" value=""> <em><font style="color:red">Otomatis</font></em></td>
		</tr>
    ...
    <?php echo $jsArray; ?> 
    function kdObat(kode_obat){ 
    document.getElementById('nama_obat').value = dt_obat[kode_obat].nama_obat; 
    document.getElementById('jenis').value = dt_obat[kode_obat].jenis; 
	document.getElementById('jumlah').value = dt_obat[kode_obat].jumlah; 
    }; 
    </script>
...
// selesai,,, untuk memanggil ID otomatis ini  bisa memasangkan cara
 ?>
		  ...
		  <tr>
			...
			<th><input name="no_resepx" type="text" size="15" value=" <?php echo  $nextID;?>"></th>
		  </tr>
    ...
    ?>   
		...
		<tr>
		<td>Nama Pasien</td>
		<td><input name="nama_pasien" id="nama_pasien" type="text" value=""> <em><font style="color:red">Otomatis</font></em></td>
		</tr>
